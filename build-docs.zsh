...
local github_url="https://github.com/genedelisa/SystemSounds"
local sdk="iphonesimulator"
local scheme="SystemSounds"
local module="SystemSounds"
...
run_jazzy() {
    ...
    # 	--clean \
    # 	--author 'Gene De Lisa' \
    # 	--author_url 'https://rockhoppertech.com/blog' \
    # 	--github_url 'https://github.com/genedelisa/SystemSounds' \
    # 	--sdk iphonesimulator \
    # 	--xcodebuild-arguments -scheme,'SystemSounds' \
    # 	--module 'SystemSounds' \
    # 	--framework-root . \
    # 	--readme README.md \
    # 	--output docs/
